...
namespace PPK::RHI
{
	...
	ConstantBuffer* ConstantBuffer::CreateConstantBuffer(uint32_t bufferSize, Renderer& renderer)
	{
		...
		// renderer.GetDevice()->CreateConstantBufferView(&constantBufferViewDesc, constantBufferHeapHandle.GetCPUHandle());
		//
